...
strategies = ['random', 'degree', 'max_min_distance','max_ave_distance', 'convex_hull']

for strategy in strategies:
    new_dict = np.load('/Users/mrsalwer/Desktop/Uni/Leiden Uni/Year-1/SNACS/proj/cords/gowala/gowalla.txt_'+strategy+'.npy', allow_pickle='TRUE')
