...
G = parse_edgelist(lines, nodetype=int)


# pick 1000 random nodes
...
print('Real Average: ', total/(num_pairs + count))
# print(dict(list(pair_wise_dist.items())[0: 100]))


strategies = ['random', 'degree', 'max_ave_distance', 'max_min_distance', 'convex_hull']

for strategy in strategies:
    new_dict = np.load('/Users/mrsalwer/Desktop/Uni/Leiden Uni/Year-1/SNACS/proj/cords/github/github.csv_'+strategy+'.npy', allow_pickle='TRUE')
